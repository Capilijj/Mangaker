...
from Homepage.homeBackend import get_bookmarked_mangas, get_mangas, get_completed_manga, get_latest_update
...
class BookmarkPage(ctk.CTkFrame):
    ...
    def display_bookmarks(self):
        ...
        all_manga_sources = []
        all_manga_sources.extend(get_mangas()) # From db list
